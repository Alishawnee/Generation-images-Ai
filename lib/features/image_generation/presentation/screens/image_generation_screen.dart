import 'package:aichat/features/global/search_text_field/search_text_field_widget.dart';
                ...
                if (imageGenerationState is ImageGenerationLoaded) {
                  return MasonryGridView.builder(
                      ...
                      itemCount: imageGenerationState
                          .imageGenerationModel.images.length,
                      itemBuilder: (context, index) {
                        final generatedImage = imageGenerationState
                            .imageGenerationModel.images[index];
